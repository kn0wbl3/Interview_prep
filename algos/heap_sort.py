# -*- coding: utf-8 -*-
"""
A heapsort is an in-place sorting algorithm that treats an array like a binary tree and moves the largest
values to the end of the heap until the full array is sorted.
...
def heapify(arr, n, i):
    ...
    # and find the largest value.   If one of the children is larger swap the values and recurse into 
    #that subree
